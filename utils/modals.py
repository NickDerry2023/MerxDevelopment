...
# This file contains all the modals for Merx. I have taken this idea from production but made it more readable and
...
class PluginConfigModal(Modal):
    ...
    async def on_submit(self, interaction: Interaction):
        ...
        response_message = f"<:whitecheck:1285350764595773451> Modules updated: {', '.join(selected_modules)}."
